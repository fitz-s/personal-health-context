...
| Eval, blind (c519ba9) | `run_manifest eval-dev/eval-holdout` + summarize | dev 42/42; holdout 12/14: E020 (co-occurrence stated as 'the explanation', 2/3 runs), E048 (absent test, 1/3 runs) → FAIL recorded | `eval-report/dev_c519ba9/`, `holdout_c519ba9/`, `summary_blind_holdout_c519ba9.json` |
